...
#ifdef TINNO_DUAL_SPEAKER
//amy add for dual speaker begin
#define SET_LSPEAKER_ON            _IOW(AUD_DRV_IOC_MAGIC, 0xb1, int)
#define SET_LSPEAKER_OFF          _IOW(AUD_DRV_IOC_MAGIC, 0xb2, int)
//amy add for dual speaker end
#endif /*TINNO_DUAL_SPEAKER*/
//GPIO
