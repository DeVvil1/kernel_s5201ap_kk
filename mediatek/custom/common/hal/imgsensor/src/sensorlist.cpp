...
//yixuhong add tinno camera start
#if defined(SP0A19_YUV_MAIN)
    YUV_INFO(SP0A19_MAIN_SENSOR_ID, SENSOR_DRVNAME_SP0A19_MAIN_YUV, NULL),
#endif
    ...
    YUV_INFO(HI257_SENSOR_ID, SENSOR_DRVNAME_HI257_YUV, NULL),
#endif
#if defined(HI258_MIPI_YUV)
    YUV_INFO(HI258_SENSOR_ID, SENSOR_DRVNAME_HI258_YUV, NULL),
#endif
#if defined(SP2519_YUV)
    YUV_INFO(SP2519_SENSOR_ID, SENSOR_DRVNAME_SP2519_YUV, NULL),
#endif
#if defined(HI545_MIPI_RAW)
    RAW_INFO(HI545MIPI_SENSOR_ID, SENSOR_DRVNAME_HI545_RAW, NULL),
#endif
