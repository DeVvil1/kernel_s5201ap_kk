...
//vcomff = vcomff + 0x00000200;
    ...
    data_array[0]=0x00023902;
    data_array[1]=0x00009a06;
    dsi_set_cmdq(data_array, 2, 1);

    data_array[0]=0x00023902;
    data_array[1]=0x00000307;
    dsi_set_cmdq(data_array, 2, 1);

    data_array[0]=0x00023902;
    data_array[1]=0x00000608;
    dsi_set_cmdq(data_array, 2, 1);
...
{
    .name           = "ili9806e_wvga_dsi_vdo_txd",
